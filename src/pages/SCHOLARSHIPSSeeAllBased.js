...
import styles from "./SCHOLARSHIPSSeeAllBased.module.css";
const SCHOLARSHIPSSeeAllBased = () => {
  ...
  return (
    <div className={styles.scholarshipsSeeAllBased}>
      <Footer />
      ...
      <SeeMoreProgressBar prop="24 / 785" propLeft="52px" />
      <div
      ...
      <div className={styles.allpageHeader}>
        <b className={styles.sortByDeadlineContainer}>Based on Your Profile</b>
      </div>
      ...
      <div className={styles.filtersWrapper}>
        <div className={styles.filterButton}>
          ...
          <div className={styles.circle1}>
            <img className={styles.vectorIcon} alt="" src="/vector211111.svg" />
        ...
        <div className={styles.filterButton}>
          ...
          <div className={styles.circle1}>
            <img className={styles.vectorIcon} alt="" src="/vector3111.svg" />
            <div className={styles.div}>1</div>
          </div>
          <div className={styles.arrows}>
            <img
        ...
        <div className={styles.filterButton}>
          ...
          <div className={styles.circle1}>
            <img className={styles.vectorIcon} alt="" src="/vector4111.svg" />
            <div className={styles.div}>1</div>
          </div>
          <div className={styles.arrows}>
            <img
        ...
        <div className={styles.filterButton}>
          ...
          <div className={styles.circle1}>
            <img className={styles.vectorIcon} alt="" src="/vector111111.svg" />
            <div className={styles.div}>1</div>
          </div>
          <div className={styles.arrows}>
            <img
        ...
        <div className={styles.filterButton}>
          ...
          <div className={styles.circle1}>
            <img className={styles.vectorIcon} alt="" src="/vector1211.svg" />
            <div className={styles.div}>1</div>
          </div>
          <div className={styles.arrows}>
            <img
      ...
      <div className={styles.headertopNavprimarybreadcr}>
        ...
        <div className={styles.pageTitle2}>
          <div className={styles.pageTitle1}>Based on Your Profile</div>
        ...
        <div className={styles.info}>
          ...
          <div className={styles.rightSideTopNav}>
            ...
            <div className={styles.buttonmedium1}>
              ...
              <div className={styles.buttonText7}>Log out</div>
            </div>
            <div className={styles.buttonmedium2}>
              <div className={styles.button1} />
              <div className={styles.buttonText7}>Dashboard</div>
            </div>
          </div>
        </div>
        <img
...
export default SCHOLARSHIPSSeeAllBased;
