...
import styles from "./BasedOnMajor.module.css";
const BasedOnMajor = () => {
  ...
  return (
    <div className={styles.basedOnMajor}>
      <Header
      ...
      <div className={styles.search}>
        <div className={styles.header}>
          ...
          <div className={styles.allpageHeader}>
            <b className={styles.basedOnYour1}>Based On Your Major</b>
          </div>
        </div>
      ...
      <div className={styles.availble}>
        <div className={styles.seeMoreProgressBar}>
          <div className={styles.scholarshipAvailable}>
      ...
      <div className={styles.seeMore}>
        <div className={styles.seeMoreProgressBar1}>
