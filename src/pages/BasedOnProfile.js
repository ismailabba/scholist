...
import styles from "./BasedOnProfile.module.css";
const BasedOnProfile = () => {
  ...
  return (
    <div className={styles.basedOnProfile}>
      <Header
      ...
      <div className={styles.search}>
        <div className={styles.header}>
          ...
          <div className={styles.allpageHeader}>
            <b className={styles.basedOnYour1}>Based On Your Profile</b>
          </div>
        </div>
      ...
      <div className={styles.scholarshipsAvailable}>
        <div className={styles.body}>
          <div className={styles.scholarshipsAvailable1}>
